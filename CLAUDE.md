# market — project-specific instructions
...
- **Verification gate** — `tests/unit/test_invariants.py` enforces PLAN.md I8 (no look-ahead in abnormal return) and I10 (monotonic-in-time scoring) against `market.scoring.abnormal_return`. This is the gate the elves Judge looks for in batch 1.
